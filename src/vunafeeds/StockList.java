...
public static String insert;
    ...
    private void initComponents() {
        ...
        categ.setModel(new javax.swing.DefaultComboBoxModel(new String[] {"CreditorID","name", "contact"}));
...
public void edit()
{
    ...
    int row = editTable.getSelectedRow();
            ...
            String contact = (String) editTable.getValueAt(row, 2);
              //creditors(creditorID,name,contact,status)           
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
            ...
            PreparedStatement pstmt = con.prepareStatement("UPDATE creditors SET Status = 'Inactive' where Status = 'Active' and CreditorID = "+Driverid+"" );
            pstmt.executeUpdate();
            
            JOptionPane.showMessageDialog(null, "Creditor details deleted");
            
           StockList win = new StockList();
           win.setVisible(true);
                 }
 ...
 try {
    ...
    private void statementActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_statementActionPerformed
         ...
         int row = editTable.getSelectedRow();
            String Driverid = (String) editTable.getValueAt(row, 0);
      stat = "Select * from purchases where creditorID = "+Driverid+"";//pass on the search string to another frame
    ...
    private void getData(String category, String para)
    {
        try{
            ...
            tableData.clear();        
            while (srs.next()) {
                String driver = srs.getString("CreditorID");
