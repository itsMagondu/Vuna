...
public class Sales extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        debtors = new javax.swing.JComboBox();
        ...
        debtors.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(debtors, 0, 258, Short.MAX_VALUE)
                            .addComponent(rate, javax.swing.GroupLayout.DEFAULT_SIZE, 258, Short.MAX_VALUE)
                            .addComponent(product, 0, 258, Short.MAX_VALUE)
                            .addComponent(sale, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 258, Short.MAX_VALUE)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(debtors, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel6))
                .addGap(18, 18, 18)
    ...
    private void admitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_admitActionPerformed
        ...
        String productS = (String) product.getSelectedItem();
        String debtorsS = (String) debtors.getSelectedItem();
        java.util.Date dat = date.getDate();
        String saleid = sale.getText();
        String Cnum = null;
        ...
        if (rateS.length() == 0 || quantityS.length() == 0 || dat == null) {
            ...
            if (debtorsS.equalsIgnoreCase("Cash")) {
                Cnum = "Cash";
            } //        else if(debtorsS.equalsIgnoreCase("Inhouse")) 
            //            {
            //            Cnum = "inhouse";
            //            } 
            else {
                int cNum = cName.indexOf(debtorsS);
                Cnum = cNumber.get(cNum);
            ...
            try {
                ...
                if (quantitiyInt > availInt) {
                    ...
                    try {
                        ...
                        if (HomePage.toEdit.equals("EditSales")) {
                            PreparedStatement psmt0 = con.prepareStatement("UPDATE sales set STATUS = 'Inactive' where STATUS = 'Active' and SaleID = '" + saleid + "'");
                            psmt0.executeUpdate();                              
                        }
...
//                else{
    ...
    private void populate() {
        ...
        debtors.removeAllItems();
        debtors.addItem("Cash");
        //debtors.addItem("Inhouse");
        try {
            int Dindex = 0;
            int Pindex = 0;
            int Sindex = 0;
    ...
    public static javax.swing.JComboBox debtors;
