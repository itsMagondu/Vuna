                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(9, 9, 9)))
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(invoiceNo, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 221, Short.MAX_VALUE)
                            .addComponent(supplier, javax.swing.GroupLayout.Alignment.LEADING, 0, 221, Short.MAX_VALUE)
                            .addComponent(total, javax.swing.GroupLayout.DEFAULT_SIZE, 221, Short.MAX_VALUE)
                            .addComponent(date, javax.swing.GroupLayout.DEFAULT_SIZE, 221, Short.MAX_VALUE))))
                .addGap(39, 39, 39))
        );
...
private void Date()
{
    ...
    private void admitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_admitActionPerformed
        ...
        String customerS = (String) supplier.getSelectedItem();
        ...
        if(invoice.length() == 0 || amount.length() == 0 || selectDate == null)  
         {
            JOptionPane.showMessageDialog(null, "Please fill all fields");
                ...
                int indexC =  sName.indexOf(customerS);
                sNum = sNumber.get(indexC);           
            
            try {              
                Class.forName("com.mysql.jdbc.Driver");
                Connection con  = DriverManager.getConnection("jdbc:mysql://localhost:3306/VunaFeeds", "root", "");
                PreparedStatement psmt = con.prepareStatement("INSERT into payments_made(invoiceNo,amount,date,Supplier_ID) values (?,?,?,?)");
                psmt.setString(1, invoice);
                psmt.setString(2, amount);
                psmt.setString(3, formatedDate);
                psmt.setString(4, sNum);
 ...
 try
        {
            ...
            ResultSet rs =stmt.executeQuery("Select * from creditors where status = 'Active'");
             supplier.removeAllItems();          
            int Pindex = 0;
            while (rs.next()) 
            {
                String customerID = rs.getString("Supplier_ID");
                String custName = rs.getString("Name");
                sName.add(Pindex, custName) ; 
                sNumber.add(Pindex,customerID); 
                
                Pindex++;
                supplier.addItem(custName);
            }
