 ...
 * @author Magondu
 */
public class PaymentIn_Statement extends javax.swing.JFrame {
    ...
    public static String till(String till) 
{
    ...
    private void initComponents() {
        ...
        setTitle("Customer Payments Made");
        ...
        jLabel2.setText("Customer Statement for Payments Made");
...
//            columns.add("Debtor Name");     
    ...
    private void printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printActionPerformed
        try {
            ...
            Logger.getLogger(PaymentIn_Statement.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//} 
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new PaymentIn_Statement().setVisible(true);
            }
        });
    }
