 ...
 * @author Magondu
 */
public class Statement_ForTest extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Customer Inclusive Statement");
        ...
        jLabel2.setText("Customer Comprehensive Statement");
...
//String dateF = from.toString();
        ...
        String getCreditor = "SELECT * FROM debtor where " + levalS + " = '" + param + "' and Status = 'Active' ";
    ...
    private void get_data(String searchString, String payString) {
        try {
            ...
            while (srs.next()) {
                ...
                srs2 = stmt2.executeQuery("Select * from debtor where Customer_ID = " + creditor + " and Status = 'Active'");
                while (srs1.next()) {
            ...
            while (srs3.next()) {
                ...
                srs2 = stmt2.executeQuery("Select * from debtor where Customer_ID = " + cust + " and Status = 'Active'");
                while (srs2.next()) {
                    creditor_name = srs2.getString("Name");
                    //System.out.println(creditor_name);
                }
...
// This comparator is used to sort vectors of data
    ...
    private void printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printActionPerformed
        try {
            ...
            Logger.getLogger(Statement_ForTest.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//} 
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new Statement_ForTest().setVisible(true);
            }
        });
    }
