 ...
 * @author Magondu
 */
public class Statement_Creditor extends javax.swing.JFrame {
    ...
    public static String till(String till) 
{
    ...
    private void initComponents() {
        ...
        setTitle("Supplier Feeds Statement ");
        ...
        editTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Purchase ID 	", "Product ID", "Quantity", "Rate ", "Total", "Date", "SupplierID "
            }
        ) {
        ...
        jLabel2.setText("Supplier Statement for Feeds supplied");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGap(23, 23, 23)
                .addComponent(stat, javax.swing.GroupLayout.PREFERRED_SIZE, 171, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
...
try{
    Class.forName("com.mysql.jdbc.Driver");
            ...
            {
            searchString = "SELECT * FROM purchases where Supplier_ID = '"+id+"'and Status = 'Active'";
            }
            else{
...
searchString = "SELECT * FROM purchases where Supplier_ID = '"+id+"'and Date > '"+f+"' and Date < '"+t+"'and Status = 'Active' ";           
}}
    ...
    private void printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printActionPerformed
        try {
            ...
            Logger.getLogger(Statement_Creditor.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//} 
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new Statement_Creditor().setVisible(true);
            }
        });
    }
