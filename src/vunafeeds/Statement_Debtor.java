 ...
 * @author Magondu
 */
public class Statement_Debtor extends javax.swing.JFrame {
    ...
    public static String till(String till) 
{
    ...
    private void initComponents() {
        ...
        editTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sale ID 	", "Product ID", "Quantity", "Rate ", "Total", "Date", "Customer ID "
            }
        ) {
...
try{
    Class.forName("com.mysql.jdbc.Driver");
            ...
            {
            searchString = "SELECT * FROM sales where Customer_ID = '"+id+"'and Status = 'Active'";
            }
            else
            {
            ...
            searchString = "SELECT * FROM sales where Customer_ID = '"+id+"'and Date > '"+f+"' and Date < '"+t+"' and Status = 'Active'";
            }
            tableData.clear();
...
//            get_data(searchString);
    ...
    private void printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printActionPerformed
        try {
            ...
            Logger.getLogger(Statement_Debtor.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//} 
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new Statement_Debtor().setVisible(true);
            }
        });
    }
