...
public void edit()
{
    ...
    int row = editTable.getSelectedRow();
            ...
            Product.productName.setText(Driverid);
            Product.ProductID.setText(name);
            Product.descript.setText(contact);
            Product.GenerateAdminNo.setEnabled(false);
            Product.admit.setEnabled(true);
            Product.productName.setEnabled(false);
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
            ...
            int option = JOptionPane.showConfirmDialog(null, "Are you sure you want to delete product "+surname,"Confirmation",type);
            ...
            PreparedStatement pstmt = con.prepareStatement("DELETE * where product_ID = "+Driverid+"" );
            pstmt.executeUpdate();
            
            JOptionPane.showMessageDialog(null, "Product details deleted");
            
           Product_Report win = new Product_Report();
           win.setVisible(true);
                 }
