 ...
 * @author Magondu
 */
public class CashIn_Report extends javax.swing.JFrame {
    ...
    public static String till(String till) 
{
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Cash In reports. Chose one category:");
...
Calendar now = Calendar.getInstance();
 ...
 if(today.isSelected())
 {
     selectDate = now.getTime();
       ...
       searchString = "SELECT * FROM payment_recieved where Date like '%"+dateToday+"%' ";       
 }
 else if(date.isSelected())
 {
       selectDate = singleDate.getDate();
        ...
        selectedDate = sdf.format(selectDate);
         searchString = "SELECT * FROM payment_recieved where Date like '%"+selectedDate+"%' ";
 }
 else if(month.isSelected())
 {
       ...
       searchString = "SELECT * FROM payment_recieved where date like '%"+searchDate+"%'";
 ...
 else if(dateRange.isSelected())
 {
    ...
    searchString = "SELECT * FROM payment_recieved where Date > '"+f+"' and Date < '"+t+"' ";
 }
 else
 {
...
//            columns.add("Debtor Name");     
    ...
    private void printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printActionPerformed
        try {
            ...
            Logger.getLogger(CashIn_Report.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//} 
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new CashIn_Report().setVisible(true);
            }
        });
    }
